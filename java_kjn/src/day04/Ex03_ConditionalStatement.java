...
public class Ex03_ConditionalStatement {
	...
	public static void main(String[] args) {
		 ...
		 *   }
		 * - 적용
		 *   - A이면 B하고, A아니고 아니면 C이면 D하고 아니면 (A 아니고 C도 아니면) F하세요.
		 *   if(A){
		 *     B;
		 *   }
		 *   else if(C){
		...
		if(이수학점 < 졸업학점) {
			System.out.println("이수학점: " + 이수학점 + " < " + "졸업학점: " + 졸업학점 + "= 졸업 실패");
		}else if(졸업작품여부) {
			System.out.println("졸업작품여부 : " + 졸업작품여부 + " = " + "졸업");
		}else {
			System.out.println("이수학점: " + 이수학점 + " > " + "졸업학점: " + 졸업학점 + ", " + "졸업작품여부 : " + 졸업작품여부 + " = 졸업 실패");
		}
