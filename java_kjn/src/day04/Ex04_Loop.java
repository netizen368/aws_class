...
public class Ex04_Loop {
	...
	public static void main(String[] args) {
		 ...
		 *   - 증감식 : 생략 가능. 조건식에서 사용하는 변수를 증가 감소시킴 => 반복횟수를 조절
		 *   - 실행순서
		 *     초기화 => 조건식(거짓) => 반복문 종료
		 *     초기화 => 조건식(참) => 실행문 => 증감식
		 *          => 조건식(참) => 실행문 => 증감식
		 ...
		 * - switch에서는 case 마지막에 break를 주어서 빠져나감
		 * - 반복문에서는 if문과 함께 사용되어 반복문을 빠져나감
		 * 
		 * continue문
		 * - 스킵
		...
		/* 무한 루프
		 * - 조건식이 항상 참이어서 반복문을 빠져나오지 못하는 상황
		 * - 보통 무한루프로 만든 후 if문과 break를 이용하여 특정 상황에서 종료되게 함
		 * for문에서 무한루프
		 * - 조건식을 생략
		 * while문에서 무한루프
		 * - 조건식에 true
