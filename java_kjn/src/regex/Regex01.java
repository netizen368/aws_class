...
public class Regex01 {
	...
	public static void main(String[] args) {
		...
		//아이디는 영문으로 시작할 때
		//주어진 아이디가 아이디 패턴에 맞는지 확인하세요
		String id2 = "Ab34567890123";
		String idRegex2 = "^[a-zA-Z]\\w{6,12}$";
		...
		String phone1 = "01000000000";
		String phoneRegex1 = "^\\d{2,3}((-\\d{4}){2}|\\d{8})$";
		
		System.out.println(phone1 + "는 전화번호 형식에 맞습니까?"
				+ Pattern.matches(phoneRegex1, phone1)); 
		...
		//도메인과 확장자는 영문또는 숫자이어야함
		//http://a.c(o)
		//http://a.b.c(o)
		//http://abc123(x)
		//abc123/com(x)
		String url = "https://abc123.ab";
