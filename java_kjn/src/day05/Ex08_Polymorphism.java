...
public class Ex08_Polymorphism {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 매개변수의 다형성
		 * - 메서드의 매개 변수로 자식 클래스들이 들어가야 하고, 메서드안 내용이 같은 경우
		 *   부모 클래스를 매개변수로 지정하는 것
		 * 객체의 다형성
		 * - 부모 클래스의 객체를 이용하여 다양한 자식 클래스의 객체를 관리할 수 있음
		 * 
		 * intanceof
		 * - 객체가 지정된 클래스로 형변이 true 또는 false로 알려줌
		 * - 사용법
		 *   - 객체 instanceof 클래스명
		 */
	...
	public static void printInstanceOf(Object obj) {
		if(obj instanceof Circle) {
			...
			System.out.println("객체는 도형로 변환이 불가능합니다.");			
		}
	...
	*/
	//위에 주석처리한 메서드 2개를 합쳐서 아래 메서드로 만들 수 있음 => 매개변수의 디형성
