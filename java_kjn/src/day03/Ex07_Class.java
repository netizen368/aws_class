...
public class Ex07_Class {
	...
	public static void main(String[] args) {
		 ...
		 * 자동차 클래스
		 * - 멤버변수
		 * 	 - 핸들, 바퀴 종류, 바퀴 수, 차종, 차명, 재조사, 색상,...
		 * - 메서드
		 *   - 시동 켜기/끄기, 기어 변속, 속도UP/DOWN
		 * - 생성자
		 *   - 초기 자동차 바퀴 종류, 바퀴 수, 차종, 차명, 제조사, 색상등을 결정
		 */
		 ...
		 * 인스턴스 필드를 사용하는 방법
		 * - 인스턴스명.필드명
		 * - 무조건 가져올 수 있는건 아님. 접근 제어자에 따라 가져오지 못할 수도 있음.
		 */
		 ...
		 * - 클래스 안에서 사용하는 변수
		 * - 필드는 자동으로 초기화가 됨
		 *   - 정수 : 0, 실수 : 0.0, 참조변수 : null, 문자 : \0, 논리 : false
		 */
		Car car1 = new Car();
		//필드는 초기화가 되기 때문에 바로 사용할 수 있음
		System.out.println("자동자 전원 : " + car1.power);
		int num;
