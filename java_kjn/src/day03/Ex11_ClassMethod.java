...
class MyCar{
	...
	void changeGear(char nextGear) {
		...
		case 'P':
			gear = nextGear;
			System.out.println("기어가 주차로 변경되었습니다.");
			break;
		case 'D':
			gear = nextGear;
			System.out.println("기어가 주행으로 변경되었습니다.");
			break;
		case 'R':
			gear = nextGear;
			System.out.println("기어가 후진으로 변경되었습니다.");
			break;
		case 'N':
			gear = nextGear;
			System.out.println("기어가 중립으로 변경되었습니다.");
			break;
		default:
