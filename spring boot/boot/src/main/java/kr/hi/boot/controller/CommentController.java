...
public class CommentController {
	...
	public ResponseEntity<String> getCommentsPost(
		...
		//서비스에게 게시글 번호와 댓글 내용, 사용자 정보를 주면서 댓글을 등록하고 결과를 문자열로 가져오라고 요청
	...
	@DeleteMapping("/posts/{posNum}/comments/{coNum}")
	public ResponseEntity<String> postsCommentsDelet(
		//화면에서 보낸 댓글 번호를 가져옴
		@PathVariable("coNum")int coNum,
		//로그인한 사용자 정보를 가져옴
		@AuthenticationPrincipal CustomUser user) {
		//서비스에게 댓글번호와 로그인한 사용자 정보를 주면서 댓글을 삭제하고 결과를 알려달라고 요처
