...
# 지도교수님이 홍교수님(P2025160001)으로 배정
UPDATE STUDENT 
SET 
    ST_PR_NUM = 'P2025160001'
WHERE
    # ST_NUM = '2025160001' OR '2025160002';
	ST_NUM IN('2025160001', '2025160002');

# 김길동(2025160003), 하니(2025160004)은 
# 지도교수님이 김교수님(P2025160002)으로 배정
UPDATE STUDENT 
SET 
    ST_PR_NUM = 'P2025160002'
WHERE
    ST_NUM = '2025160003' OR '2025160004';
...
BEGIN
	...
	DECLARE _MID INT; # 중간 100점 만점
    DECLARE _FINAL INT; # 기말 100점 만점
    DECLARE _HW INT; # 과제 100점 만점
    DECLARE _ATT INT; # 출석 100점 만점
    DECLARE _TOTAL DOUBLE; # 성적을 비율로 반영한 총점
    DECLARE _SCORE VARCHAR(2); # 학점 
    
    # 예외가 발생하면 이전에 작업한 내용이 반영되지 않도록 ROLLBACK 
