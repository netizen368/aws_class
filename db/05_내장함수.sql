# 내장 함수
# if(수식, 수식1, 수식2) : 수식이 참이면 수식1을, 거짓이면 수식2을 반환
SELECT IF(2>1, 2, 1);

# IFNULL(수식1, 수식2) 
# - 수식1이 NULL이 아니면 수식1을, NULL이면 수식2을 반환
...
# - 기준문자열에서 위치부터 길이만큼 지우고 그 위치에서 삽입할문자열을 추가
...
# DATE/TIME(날짜) : 날짜에서 년-월-일/시:분:초를 추출
...
# - 날짜1/시간1에서 날짜2/시간2의 차이를 시:분:초로 반환. 날짜1/시간1 - 날짜2/시간2
