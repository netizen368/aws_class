...
# 테이블 이름만 하는 경우 => 내가 작업하려는 DB가 선택되어 있어야 정상 동작
...
# 설정 변경 방법
# Edit > Preperences... > SQL Editor에서 제일 하단에 Safe Upates(~~~) 체크박스를 해제
# 아래 코드를 MySQL Commane Line Client에서는 에러 없이 실행
